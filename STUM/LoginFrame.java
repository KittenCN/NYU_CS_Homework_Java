...
public class LoginFrame extends JFrame {
    ...
    private void initUI(){
        ...
        gbc.gridx=0; gbc.gridy=1; panel.add(new JLabel("密码:"), gbc);
        pfPwd=new JPasswordField(15);
        gbc.gridx=1; panel.add(pfPwd,gbc);
        add(panel, BorderLayout.CENTER);
        JPanel btnPanel=new JPanel(); btnPanel.setOpaque(false);
        JButton btnLogin=new JButton("登录"); JButton btnCancel=new JButton("取消");
        btnPanel.add(btnLogin); btnPanel.add(btnCancel);
