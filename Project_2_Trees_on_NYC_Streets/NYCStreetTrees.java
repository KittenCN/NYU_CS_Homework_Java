package Project_2_Trees_on_NYC_Streets;
...
public class NYCStreetTrees{
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		while (true){
			...
			//nyc tree counts 
			int nycTotalSpecies = treeList.getCountByTreeSpecies(userSpecies);
			...
			int manTotalSpecies = treeList.getCountByTreeSpeciesBorough(userSpecies, "manhattan");
			int manTotalTrees = treeList.getCountByBorough("Manhattan");
			double manPercent = ((double)manTotalSpecies/(double)manTotalTrees)*100;
			
			//Bronx tree counts
			int bronxTotalSpecies = treeList.getCountByTreeSpeciesBorough(userSpecies, "bronx");
			...
			int brookTotalSpecies = treeList.getCountByTreeSpeciesBorough(userSpecies, "Brooklyn");
			...
			//Queens tree counts
			int queensTotalSpecies = treeList.getCountByTreeSpeciesBorough(userSpecies, "Queens");
			...
			int statenTotalSpecies = treeList.getCountByTreeSpeciesBorough(userSpecies, "Staten Island");
